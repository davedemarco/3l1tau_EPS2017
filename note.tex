...
\author{David A. DeMarco, Tina Ojeda, Pierre Savard}
...
\begin{document}
	...
	\section{Event selection \& signal region optimization} 

	\begin{table}[H]
		\caption{MC yields in $3\ell+\tau_{\text{had}}$ signal region} 
		\resizebox{1.0\textwidth}{!}{
		\begin{tabular}{|c|c|c|c|c|c|c|}
		\hline
		\textbf{$3\ell+\tau_{\text{had}}$ signal region} 	& ttH                & ttZ                  & Rare prompt            & Nonprompt                & ttbar                    & Sum bkg                     \\
		\hline
